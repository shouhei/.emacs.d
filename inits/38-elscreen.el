...
(global-set-key (kbd "C-x <left>") 'elscreen-next)
(global-set-key (kbd "C-x <right>") 'elscreen-previous)
(global-set-key (kbd "C-x C-<left>") 'elscreen-next)
(global-set-key (kbd "C-x C-<right>") 'elscreen-previous)
(global-set-key (kbd "C-x n") 'elscreen-next)
(global-set-key (kbd "C-x p") 'elscreen-previous)
(global-set-key (kbd "C-x C-n") 'elscreen-next)
(global-set-key (kbd "C-x C-p") 'elscreen-previous)
